...
import { CopyCVIcon, EmailCVIcon, FaceCVIcon, IconDownloadIntroduceCv, IconEditIntroduceCv, IconMagicWandIntroduceCv } from '#components/Icons';
            ...
            <div className='introduce-cv-container'>
                <div className='introduce-cv-content'>
                    ...
                    <div className='introduce-cv_item'>
                        ...
                        <p>
                            {languageRedux === 1
                                ? 'HiJob sẽ tự động điền thông tin từ hồ sơ của bản. Xem và chọn mẫu CV mà bạn ưng ý.'
