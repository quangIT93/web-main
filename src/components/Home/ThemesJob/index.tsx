...
const ThemesJob: React.FC = () => {
  ...
  const handleChange = async (event: React.ChangeEvent<unknown>, value: number) => {
    ...
    const themeId = searchParams.get(`theme-id`) ? searchParams.get(`theme-id`) : listTheme?.data[0].id
      ...
      <>
        {
          automatic && (
            <>
                    ...
                    >
                      <ImageListItem key={item.image} sx={{ flex: 1, display: 'flex' }}>
                        <img
                          ...
                          alt={item.title}
                          loading="lazy"
                          style={{ width: '120px', maxWidth: 'auto', maxHeight: '120px', borderRadius: 10, height: "100% " }}
                        />
              ...
              <Stack
                spacing={2}
                sx={{ display: 'flex', alignItems: 'center', margin: '24px 0', marginBottom: "50px" }}
              >
                ...
                /> */}
                <Space className='div-hover-more'
