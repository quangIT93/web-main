...
import { ThinkingIcon, NewsPaperIcon, UseCircleIcon, EysIcon, LikeIcon, CommentIcon } from '#components/Icons';
            ...
            <div className="community-content">
                <div className="community-content_item">
                    <div className="community-content-title">
                        ...
                        <p onClick={() => window.open("/new-comunity", "_parent")}>View all</p>
                    </div>
