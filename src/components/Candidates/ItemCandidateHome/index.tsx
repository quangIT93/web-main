...
const ItemCandidateHome: React.FC<ICadidate> = (props) => {
    const { item } = props;
    ...
    return (
        <>
            <div
                className="item-candidate-home"
                onClick={() => {
                    handleClickItemCandidate(item.accountId);
                }}
            >
                <div className="wrap-img_candidate_home">
                    <img
                        src={
                        ...
                        alt=""
                        className="img-candidate-home"
                    />
                    <div className="wrap-name-age-home">
                        <div className="wrap-name-age-home_item">
                            <span className="icon-age_item-candidate-home">
                                <PersonIcon />
                            </span>
                            <span>
                ...
                <div className="info-candidate-home">
                    <div className="info-candidate-home_item">
                        <p>{item.name}</p>
                        {/* <CandidateHijob /> */}
                    </div>
                    <ul>
            ...
            <div className="item-gender item-infoUser">
              ...
              <span>{item.genderData}</span>
                        ...
                        <li>
                            <span className="icon-info-candidate-home">
                                <SchoolIcon />
                            </span>
                            <Tooltip
                                placement="top"
                            ...
                            >
                                <span className="text-info-candidate-home">
                                    {item.profilesEducationsData.length !== 0
...
export default ItemCandidateHome;
