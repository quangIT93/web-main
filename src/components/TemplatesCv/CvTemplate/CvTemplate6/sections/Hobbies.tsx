...
const Hobbies: React.FC<ICvExperience> = (props) => {
            ...
            <View style={styles.hobby} >
                <View style={styles.right}>
                    <View style={styles.topInfo}>
                        ...
                        <Text style={styles.school}>{profile?.profileHobbies?.description}</Text>
                    </View>
                    {/* <View style={styles.botInfo}>
                                    <View style={styles.timeContainer}>
                                        <Text style={styles.time}>
                                            {moment(Hobbies?.startDate).format('YYYY')}
                                        </Text>
                                        <View style={styles.line}></View>
                                        <Text style={styles.time}>
                                            {moment(Hobbies?.endDate).format('YYYY')}
                                        </Text>
                                    </View>
                                    <Text style={styles.detail}>{Hobbies?.extraInformation}</Text>
                                </View> */}
                </View>
            </View>
        </View>
