...
const TemplatesCv: React.FC = () => {
  ...
  const handleClickSaveCv = async () => {
    ...
    const selectedTemplate = templatesCv.find(
      (template) => template.id === Number(localStorage.getItem('cv-id')) ?
    ...
    try {
      if (selectedTemplate) {
        ...
        const name = localStorage.getItem('nameCv') !== null ?
          localStorage.getItem('nameCv') : 'Resume 1'
        ...
        <div className="contentCV-top">
          ...
          <div className="change-styles">
            <div className="change-styles_font">
              <div className={unDown ? "minusCircle unable" : "minusCircle"} onClick={handleClickMinusCircle}>
                <MinusCircle />
              </div>
              <p style={{ fontSize: fontSizeCV }}>A</p>
              <div className={unUp ? "plusCircle unable" : "plusCircle"} onClick={handleClickPlusCircle}>
                <PlusCircle />
              </div>
            </div>
