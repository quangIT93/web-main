                    ...
                    <div className={styles.new_page_cv_header_content}>
                        <div className={styles.content}>
                            ...
                            <div className={styles.btn_count_cv}>
                                ...
                                >
                                    {languageRedux === 1 ? 'Tạo CV cho riêng bạn'
                                        : languageRedux === 2 ? 'Create your own CV' :
                                            '나만의 이력서 만들기'}
                                </Button>
                    ...
                    <div className={styles.templates_content}>
                        <div className={styles.new_page_cv_templates_left}>
                            ...
                            <Button
                                ...
                                onClick={handleMoveToCreateCv}
                            >
                                {languageRedux === 1 ? 'Chọn mẫu sơ yếu lý lịch'
                                    : languageRedux === 2 ? 'Choose a cv template' :
                                        '이력서 템플릿을 선택하세요'}
                            </Button>
                        </div>
                    ...
                    <div className={styles.resume_content}>
                        <div className={styles.resume_content_left}>
                            ...
                            <Button
                                ...
                                onClick={handleMoveToCreateCv}
                            >
                                {languageRedux === 1 ? 'Bắt đầu bây giờ'
                                    : languageRedux === 2 ? 'Start now' : '지금 시작하세요'}
                            </Button>
                        </div>
