...
const Profile: React.FC = () => {
  ...
  const [openModalExperienceCreate, setOpenModalExperienceCreate] =
    useState(false);
  const [openModalSkills, setOpenModalSkills] =
    useState(false);
  const [openModallanguages, setOpenModallanguages] =
    useState(false);
        ...
        <Skeleton className="skeleton-item" loading={loading} active>
          <div className="div-profile-info">
            ...
            {/* <div className="section-list">
              <div className="section-list_top">
              ...
              <div className="section-list_bottom">
              <div className="section-item">
                <SectionLanguageIcon />
                <h3>{languageRedux === 1 ? "Ngôn ngữ" : "Languages"}</h3>
              </div>
