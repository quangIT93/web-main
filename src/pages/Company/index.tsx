...
const Company = () => {
    ...
    const handleSubmit = (
        ...
        formData.append('companyRoleId', String(dataCompany?.companyRoleInfomation?.id));
        formData.append('companySizeId', String(dataCompany?.companySizeInfomation?.id));
