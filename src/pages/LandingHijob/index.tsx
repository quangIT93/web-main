...
const LandingHijob = () => {
    ...
    const handleMoveToRegister = () => {
        const register_form = document.getElementById("landing_hijob_register_form") as HTMLElement;
        // register_form.scrollIntoView();
        let newJobOffsetTop = 0;
        if (register_form) {
            newJobOffsetTop = document.getElementById("landing_hijob_register_form") ? register_form.offsetTop : 0;
            ...
            <div className={styles.landing_hijob_content}>
                ...
                <div className={styles.landing_register}>
                    ...
                    <div className={styles.register_content}>
                        ...
                        <div id="landing_hijob_register_form" className={styles.register_form}>
                            <h3>
                                {
                                    languageRedux === 1 ?
                                        "Đăng kí nhận tư vấn" :
                            ...
                            <form className={styles.register_form_container} ref={form} onSubmit={handleSubmit}>
                            ...
                            >
                                {languageRedux === 1 ? 'Gửi yêu cần tư vấn ngay' : 'Send request for advice now'}
                            </Button>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.landing_login}>
                    ...
                    <div className={styles.landing_login_right}>
                        ...
                        <Button
                            ...
                            style={{
                                display: !localStorage.getItem("accessToken") ? "block" : "none",
                            }}
                        >
